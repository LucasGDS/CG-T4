...
//obtem location de atributos dos vertices.
// gl.getAttribLocation(program,"vertexPos");
// gl.getAttribLocation(program, "color");
 
 //Obtem location de variaveis uniformes.
...
function initProgram(){
    ...
    {
      var vertexShaderSrc = document.getElementById("vertexShaderSrc2").text;
      var fragmentShaderSrc = document.getElementById("fragmentShaderSrc2").text;
    }
    ...
    program.lightDirUniform = gl.getUniformLocation(program, "u_reverseLightDirection");
    program.lightColUniform = gl.getUniformLocation(program, "u_colorLight");
    program.lightAmbUniform = gl.getUniformLocation(program, "u_amb");
    program.vertexColorAttr = gl.getAttribLocation(program, "color");
    program.normalsAttr = gl.getAttribLocation(program, "a_normal");
...
function createCube(){
    ...
    gl.vertexAttribPointer(program.normalsAttr,3,gl.FLOAT,false,0,0);
...
function redraw(){
    ...
    vec3.normalize(lightdir,[-1.0,1.0,1.0]);

    gl.uniform3fv(program.lightColUniform ,[1.0,1.0,1.0]);
    gl.uniform3fv(program.lightDirUniform ,lightdir);
    gl.uniform3fv(program.lightAmbUniform ,[0.1,0.1,0.1]);
